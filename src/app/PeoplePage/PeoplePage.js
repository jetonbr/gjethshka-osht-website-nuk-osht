...
import ContainerExampleContainer from './PeopleContainer';
import CardExampleGroups from './PeopleContent';
import ContainerExampleBasic from './PeopleDivider';
import ContainerExampleSponsor from './PeoplePayCard';
    ...
    render() {
        return (
            ...
            <Grid>
                ...
                <CardExampleGroups />
                <ContainerExampleSponsor />
            </Grid>
            {/* {this.paginationPeople()} */}
            <ContainerExampleBasic />
            </React.Fragment>
